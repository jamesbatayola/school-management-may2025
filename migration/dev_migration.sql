...
CREATE TABLE IF NOT EXISTS students (
    ...
    FOREIGN KEY (guardian_id) REFERENCES guardians (id) ON DELETE CASCADE NOT NULL,
...
CREATE TABLE IF NOT EXISTS student_levels (
    ...
    FOREIGN KEY (level_id) REFERENCES levels (id) ON DELETE CASCADE NOT NULL, 
    FOREIGN KEY (student_id) REFERENCES students (id) ON DELETE CASCADE NOT NULL,
...
CREATE TABLE IF NOT EXISTS classes (
    ...
    FOREIGN KEY (course_id) REFERENCES courses (id) ON DELETE CASCADE NOT NULL,
    FOREIGN KEY (year_id) REFERENCES school_years (id) ON DELETE CASCADE NOT NULL,
    FOREIGN KEY (term_id) REFERENCES terms (id) ON DELETE CASCADE NOT NULL,
...
CREATE TABLE IF NOT EXISTS enrollments (
    id SERIAL PRIMARY KEY NOT NULL,
    student_id UUID UNIQE NOT NULL,
    course_id INTEGER NOT NULL,
